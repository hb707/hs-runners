  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100dvh', backgroundColor: '#0D0D10' }}>
      ...
      <nav style={{
        ...
        width: '100%', maxWidth: '430px', backgroundColor: '#16161C',
        borderTop: '1px solid #252530', paddingBottom: 'env(safe-area-inset-bottom)', zIndex: 50,
      }}>
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  justifyContent: 'center', paddingTop: '12px', paddingBottom: '12px',
                  gap: '4px', fontSize: '11px', fontWeight: isActive ? 700 : 400,
                  color: isActive ? '#FF6B00' : '#5A5A72', textDecoration: 'none',
